 ...
 * includes/footer.php
 * ------------------------------------------------
 * Closes </main>, prints the site footer, mobile menu,
 * and loads all JS. Include this at the bottom of every
 * storefront page, after your page content.
 */
?>
</main><!-- End .main -->
