            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="products">
                        <i class="material-symbols-rounded opacity-5">Products</i>
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="../admin/reports.php">
                        <i class="material-symbols-rounded opacity-5">Reports</i>
